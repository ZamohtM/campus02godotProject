...
public partial class MainContext : Control
{
	...
	public override async void _Ready()
	{
		...
		JArray responseOwner = await connector._get_shoppinglists_owner_request(GlobalData.Instance.Email,GetNode<HttpRequest>("HTTPOwner"));
		JArray responseShared = await connector._get_shoppinglists_shared_request(GlobalData.Instance.Email,GetNode<HttpRequest>("HTTPShared"));
